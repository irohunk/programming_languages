...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { description: @language.description, link: @language.link, title: @language.title } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { description: @language.description, link: @language.link, title: @language.title } }
